...
export DATA=./data
export TRAIN=$DATA/patb-egy_train.conllx
export DEV=$DATA/Egyptian/arz_dev.conllx
export TEST=$DATA/Egyptian/arz_test.conllx
export CONFIG=$ROOT/biaffine.bert.default.ini
export BERT=ashabrawy/egy_aligned_msa
